package com.quickpolls.core.service;

import com.quickpolls.core.dto.model.OptionData;
import com.quickpolls.core.dto.model.PollData;
import com.quickpolls.core.dto.model.UserData;
import com.quickpolls.core.exception.AuthException;
import com.quickpolls.core.exception.SurveyNotFoundException;
import com.quickpolls.core.exception.UserNotFoundException;
...
import com.quickpolls.core.repository.OptionRepository;
import com.quickpolls.core.repository.PollRepository;
import com.quickpolls.core.repository.UserRepository;
import com.quickpolls.core.repository.VoteRepository;
import com.quickpolls.core.security.JwtTokenProvider;
...
public class PollService {
    ...
    public List<PollData> getAllPolls() {
        ...
        for(Poll p : polls) {
            UserData userData = new UserData(p.getUser().getId(), p.getUser().getNickname());
